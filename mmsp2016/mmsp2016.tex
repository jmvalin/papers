...
had not been applied to complete video codecs before. While Daala is not yet
...
In this description, a \textit{block} refers to
a square transform block. Block sizes in Daala range from $4 \times 4$
